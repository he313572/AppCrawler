...
@Component
public class ZolDigitalCrawler implements PageProcessor {
	...
	public void process(Page page) {
		if (!page.getUrl().regex("http://dcdv.zol.com.cn/\\d{3}/\\d+.html").match()) {
			page.addTargetRequests(page.getHtml().css("div .content-mod").links().regex("http://dcdv.zol.com.cn/\\d{3}/\\d+.html").all());
		} else {
